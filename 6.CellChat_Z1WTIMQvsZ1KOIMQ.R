...
setwd("/Users/lucia/Documents/23.psoriasis/08.CellchatComparison/02.Z1KOIMQvsZ1WTIMQ/")
...
saveRDS(cellchat, file = "cellchat_comparisonAnalysis_Z1WTIMQ_vs_Z1KOIMQ.rds")

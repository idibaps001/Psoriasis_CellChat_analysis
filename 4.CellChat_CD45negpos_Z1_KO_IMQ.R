...
Z1_KO_IMQ <- subset(Z1_KO_IMQ, idents = c("Dendritic epidermal T cells", "M1-like Macrophages", "Foxp3+ Tregs", "Vγ6 T cells",  "Vγ4 T cells",  "Slamf9+ Macrophages", "Conventional CD4+ T cells", "Langerhans cells",  "Selenop+ M2-like Macrophages", "DoubleNegative T cells", "Resident M2-like Macrophages", "Monocytes", "ILC2", "Neutrophils", "MHCII+Ccr2+ Macrophages", "Cytotoxic CD8+ T cells", "Mature Monocytes" , "Proliferative CD4+ T cells", "Proliferative LC", "pDC", "Granular keratinocytes", "Stromal cells cycling", "Basal keratinocytes", "Supra-Basal keratinocytes", "Universal fibroblasts", "Basal keratinocytes cycling", "Endothelial cells", "Reticular fibroblasts", "Inner ear fibroblasts", "Hair dermal sheath", "Cornified keratinocytes", "Dermal fibrocytes"    
))
...
#Slamf9+ Macrophages  Dendritic epidermal T cells          M1-like Macrophages         Vγ6 T cells      MHCII+Ccr2+ Macrophages                    Monocytes             Langerhans cells               Neutrophils Selenop+ M2-like Macrophages 
#332                          101                          388                          233                          429                          206                           99                          531                          563 
#Conventional CD4+ T cells   DoubleNegative T cells      Foxp3+ Tregs   Proliferative CD4+ T cells             Mature Monocytes           Vγ4 T cells Resident M2-like Macrophages       Cytotoxic CD8+ T cells                         ILC2 
#142                           93                          134                           46                          109                          208                           72                           20                           17 
#pDC             Proliferative LC        Universal fibroblasts        Reticular fibroblasts            Endothelial cells    Supra-Basal keratinocytes        Inner ear fibroblasts      Cornified keratinocytes       Granular keratinocytes 
#11                           19                         1195                         1216                          179                          120                          428                          210                          164 
#Hair dermal sheath          Basal keratinocytes        Stromal cells cycling  Basal keratinocytes cycling            Dermal fibrocytes 
#51                           23                          136                          127                           47 
...
write.csv2(df.net, file = "CD45NEGPOS-Z1_KO_IMQ-CellChat-net.csv")
write.csv2(df.netP, file = "CD45NEGPOS-Z1_KO_IMQ-CellChat-netP.csv")

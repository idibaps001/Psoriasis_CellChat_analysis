...
CD45POS_Z1_WT_IMQ <- Z1_WT_IMQ

setwd("/Users/lucia/Documents/23.psoriasis/07.cellchat/02_z1_wt_imq/cd45negANDcd45pos/")
load("CD45NEG_Z1_WT_IMQ.rds")
CD45NEG_Z1_WT_IMQ <- Z1_WT_IMQ

#Merge normalized seurat objects
#https://satijalab.org/seurat/articles/merge_vignette.html
CD45POS_Z1_WT_IMQ <- NormalizeData(CD45POS_Z1_WT_IMQ)
CD45NEG_Z1_WT_IMQ <- NormalizeData(CD45NEG_Z1_WT_IMQ)
Z1_WT_IMQ <- merge(CD45POS_Z1_WT_IMQ, y = CD45NEG_Z1_WT_IMQ,add.cell.ids = c("cd45pos", "cd45neg"), project = "psoriasis", merge.data = TRUE)

length(Cells(CD45POS_Z1_WT_IMQ)) #[1] 4720
